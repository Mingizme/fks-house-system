...
- **Departments ngang hàng**: Security · Linguistic · Admin · Staff · Media · Judge · Executive Protection Bureau (EPB) · Financial Department. Admin thuộc các department này **không được phép quản trị lẫn nhau** (Mute/Demote/Kick).
